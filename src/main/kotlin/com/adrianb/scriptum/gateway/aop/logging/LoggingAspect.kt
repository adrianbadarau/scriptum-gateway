package com.adrianb.scriptum.gateway.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianb.scriptum.gateway.repository..*)" +
            " || within(com.adrianb.scriptum.gateway.service..*)" +
            " || within(com.adrianb.scriptum.gateway.web.rest..*)"
    )
